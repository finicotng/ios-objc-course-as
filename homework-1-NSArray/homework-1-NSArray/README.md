...
### Уровень ученик:
_(просто повторение, того что увидел)_
...
_(небольшая импровизация + дополнительная мозговая деятельность)_
...
### Уровень Мастер:
_(простор для фантазии + больше мозговой деятельности + больше практики)_
...
### Уровень Звезда:
_(разобраться с тем, чего Леша не объяснял! + реальная задача!)_
...
### Уровень Супермен!
_(кодинг за гранью возможного! + вероятность успеха практически 0! + реальный вызов!)_
